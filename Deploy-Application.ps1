...
Try {
	...
	[string]$appVendor = 'Salt Software LLC'
	[string]$appName = 'Salt Instructional'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## <Perform Installation tasks here>
			Execute-MSI -Action 'Install' -Path "$dirFiles\WinSalt18Instructional.msi" -Parameters "/qn"

			Copy-File -Path "$dirSupportFiles\SALT Instructional LIC.dat" -Destination "$envProgramFilesX86\SALT Software\Salt 18\"
			Copy-File -Path "$dirSupportFiles\SALTInstructional SYS.ini" -Destination "$envProgramFilesX86\SALT Software\Salt 18\"
